...
BEGIN_AFTERNOON_HEATING_BY_HOUR = 13
WORKDAY_AFTERNOON_COMFORT_BY_HOUR = 15
...
# Price info (SEK excl VAT)
TRANSFER_AND_TAX_COST_PER_MWH_EXCL_VAT = 665.8  # incl 55.8 broker and 250 transfer fee
...
ABSOLUTE_SEK_PER_MWH_TO_CONSIDER_CHEAP = 360.0
ABSOLUTE_SEK_PER_MWH_BEYOND_WHICH_TO_REDUCE_COMFORT = 5000.0  # firewood / gas cheaper
...
HEATPUMP_CAPACITY_AGE_FACTOR = 0.87  # Percent of heating watts remaining
